 ...
 *   1. Fetch initial snapshot via GET /api/draft/state.
 *   2. Open SSE connection to /api/draft/stream.
 ...
 */
export function useDraftStream(initial: DraftSnapshot | null = null) {
