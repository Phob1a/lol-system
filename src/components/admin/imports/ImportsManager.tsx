...
export function ImportsManager() {
  ...
  return (
    <div className="space-y-4">
      ...
      <ArenaPanel className="p-5">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <h1 className="mt-2 text-xl font-black text-white">对局导入</h1>
            <p className="mt-1 text-sm text-slate-300">待审核的 LCU 对局记录</p>
          </div>
      ...
      {/* Table */}
      {listLoading ? (
        <ArenaPanel className="p-5 text-sm text-slate-300">加载中…</ArenaPanel>
      ) : (
